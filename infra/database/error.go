...
// for a unique constraint violation, capturing the offending field and value.
...
// violation. When it is, it also returns the offending field and value,
// extracted from the driver error detail when possible.
func AsDuplicateKeyError(err error) (field string, value string, ok bool) {
